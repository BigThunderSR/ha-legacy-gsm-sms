"""The legacy_gsm_sms gateway to interact with a GSM modem."""
...
class Gateway:
    """Legacy GSM SMS gateway to interact with a GSM modem."""

    def __init__(self, config, hass):
        """Initialize the legacy GSM SMS gateway."""
    ...
    def sms_pull(self, state_machine):
        """Pull device for legacy GSM SMS.
    ...
    def sms_read_messages(self, state_machine, force=False):
        """Read all received Legacy GSM SMS messages.
...
async def create_legacy_gsm_sms_gateway(config, hass):
    """Create the legacy GSM SMS gateway."""
    try:
